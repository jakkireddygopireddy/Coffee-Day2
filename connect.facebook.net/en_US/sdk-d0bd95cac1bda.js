/*1635846455,,JIT Construction: v1004658278,en_US*/
...
try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("UserAgentData", [], {
                    ...
                    "browserFullVersion": "94.0.4606.85",
                ...
                __d("ApiBatcher", ["invariant", "ApiClientUtils", "QueryString", "sdk.safelyParseResponse", "whitelistObjectKeys"], (function(a, b, c, d, e, f, g, h) {
                    ...
                    a = function() {
                        ...
                        b.scheduleBatchCall = function() {
                            ...
                            this.$1.push(l);
                            this.$2.push(h);
                            this.$1.length == i ? (this.$4 && clearTimeout(this.$4), this.$5()) : this.$4 || (this.$4 = setTimeout(function() {
                                b.$5()
                            }, 0))
                        };
                ...
                __d("sdk.Cookie", ["QueryString", "sdk.Runtime"], (function(a, b, c, d, e, f, g) {
                    var h = null;
                    ...
                    function a(a, b, e, f) {
                        ...
                        try {
                            if (self.document) {
                                ...
                                g && (a = c("QueryString").appendToUrl(a, c("QueryString").encode({
                                    __cppo: g
                                })))
                            }
                        } catch (a) {}
                ...
                __d("sdk.api", ["ApiClient", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.feature", "sdk.warnInsecure"], (function(a, b, c, d, e, f, g) {
                ...
                __d("Miny", ["orEmptyArray"], (function(a, b, c, d, e, f, g) {
                    var h = "Miny1",
                ...
                __d("sdk.AppEvents", ["AppUserPropertyAPIBuiltinField", "Assert", "FBAppEvents", "sdk.Event", "sdk.Impressions", "sdk.Model", "sdk.Runtime"], (function(a, b, c, d, e, f, g) {
                    var h = Object.freeze({
                ...
                __d("sdk.Observable", [], (function(a, b, c, d, e, f) {
                    a = function() {
                        function a() {
                            this.$1 = {}, this.getSubscribers = ES(this.getSubscribers, "bind", !0, this), this.clearSubscribers = ES(this.clearSubscribers, "bind", !0, this), this.subscribe = ES(this.subscribe, "bind", !0, this), this.unsubscribe = ES(this.unsubscribe, "bind", !0, this), this.inform = ES(this.inform, "bind", !0, this)
                        }
                        var b = a.prototype;
                ...
                __d("sdk.Auth", ["Log", "QueryString", "UrlMap", "sdk.AuthState", "sdk.AuthStorageUtils", "sdk.AuthUtils", "sdk.Cookie", "sdk.Frictionless", "sdk.LoggingUtils", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.UA", "sdk.URI", "sdk.feature", "sdk.statusCORS"], (function(a, b, c, d, e, f, g) {
                    b("sdk.Frictionless");
                    var h = 5 * 1e3,
                    ...
                    function e(a, b, e, f) {
                        return function(e) {
                            if (e && e.access_token) {
                                ...
                                asset_scopes: ES("JSON", "parse", !1, e.asset_scopes)
                            }, b = o(b, e), d("sdk.AuthUtils").removeLogoutState(), g = "connected", l(b, g), n(f);
                    ...
                    var n = c("Type").extend({
                        ...
                        o = {
                            ...
                            _makeActive: function(a) {
                                o._setDialogSizes(), o._lowerActive(), o._active = a, c("sdk.Runtime").isEnvironment(c("sdk.Runtime").ENVIRONMENTS.CANVAS) && d("sdk.Canvas.Environment").getPageInfo(function(a) {
                                    o._centerActive(a)
                                }), o._centerActive()
                            },
                ...
                __d("sdk.UIServer", ["Log", "QueryString", "UrlMap", "createObjectFrom", "flattenObject", "guid", "insertIframe", "justknobx", "resolveURI", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Extensions", "sdk.Frictionless", "sdk.LoggingUtils", "sdk.Native", "sdk.Popup", "sdk.RPC", "sdk.Runtime", "sdk.UA", "sdk.XD", "sdk.api", "sdk.fbt", "sdk.feature", "sdk.getContextType", "sdk.modFeatureCheck", "sdk.openMessenger"], (function(a, b, c, d, e, f, g) {
                    var h = {
                    ...
                    function i(a) {
                        return p.isOAuth(a) && b("sdk.Extensions").supportsDialog("oauth")
                    }

                    function j(a) {
                        return p.isOAuth(a) && (a.is_account_link === !0 || a.is_account_link === "true") && b("sdk.Extensions").supportsDialog("accountLink")
                    }
                    ...
                    function k(a) {
                        ...
                        a.params.display === "async" ? (ES("Object", "assign", !1, a.params, {
                            ...
                            response_type: f,
                            domain: location.hostname
                        }), a.cb = b("sdk.Auth").xdResponseWrapper(c, b("sdk.Auth").getAuthResponse(), "permissions.oauth", a.params)) : (e && p._xdNextHandler(function(a) {
                            c({
                                authResponse: null,
                            ...
                            client_id: b("sdk.Runtime").getClientID(),
                            redirect_uri: b("resolveURI")(p.xdHandler(c, d, a.params.plugin_prepare ? "opener.parent" : "opener", b("sdk.Auth").getAuthResponse(), "permissions.oauth", !e, a.params)),
                            origin: b("sdk.getContextType")(),
                            response_type: f,
                            domain: location.hostname
                        }));
                        d = a.params && a.params.tp && a.params.tp !== "unspecified";
                        !a.params.plugin_prepare && !d && b("sdk.LoggingUtils").logEvent(a.params.logger_id, b("sdk.LoggingUtils").logEventName.loginStart, {
                            cbt_delta: 0
                        });
                        return a
                    }
                    a = {
                        ...
                        apprequests: {
                            transform: function(a) {
                                ...
                                if (a.params.frictionless) {
                                    if (b("sdk.Frictionless").isAllowed(a.params.to)) {
                                        var d = c("justknobx")._("221");
                                        d === !0 ? (a.params.display = "popup", a.params.in_iframe = !1) : (a.params.display = "iframe", a.params.in_iframe = !0);
                                        a.hideLoader = !0
                                    }
                        ...
                        photo_picker: {
                            ...
                            transform: function(a) {
                                if (!b("sdk.Runtime").getClientID()) {
                                    b("Log").error("Photo Picker was called before FB.init().");
                                    return
                                }
                                var c = a.cb,
                                    d = a.id;
                                ...
                                ES("Object", "assign", !1, a.params, {
                                    client_id: b("sdk.Runtime").getClientID(),
                                    redirect_uri: b("resolveURI")(p.xdHandlerPhotoPicker(c, d, a.params.plugin_prepare ? "opener.parent" : "opener", "photo_picker", a.params)),
                                    origin: b("sdk.getContextType")(),
                                    domain: location.hostname
                                });
                                return a
                    ...
                    var p = {
                        ...
                        prepareCall: function(a, c) {
                            var d = a.method.toLowerCase(),
                                e = Object.prototype.hasOwnProperty.call(p.Methods, d) ? babelHelpers["extends"]({}, p.Methods[d]) : {},
                                f = a.id || b("guid")(),
                                g = !0;
                            ...
                            a.display = p.getDisplayMode(e, a);
                            e.url || (e.url = "dialog/" + d);
                            (e.url == "dialog/oauth" || e.url == "dialog/permissions.request") && (a.display == "iframe" || a.display == "touch" && a.in_iframe) && (a.display = p.checkOauthDisplay(a));
                            if (e.url == "dialog/oauth") {
                                if (m >= ((g = b("sdk.feature")("max_oauth_dialog_retries", 100)) != null ? g : 100)) {
                            ...
                            g = {
                                cb: c,
                                id: f,
                                size: e.size || p.getDefaultSize(),
                                url: b("UrlMap").resolve(a.fx_app === "instagram" || a.fx_app === "ig_single" ? "www_instagram" : a.display == "touch" ? "m" : "www") + "/" + e.url,
                                params: a,
                                name: d,
                                dialog: b("sdk.Dialog").newInstance(f, a.display)
                            };
                            c = e.transform ? e.transform : p.genericTransform;
                            if (c) {
                                g = c(g);
                                if (!g) return
                            }
                            a.display === "touch" && a.in_iframe && (g.params.parent_height = window.innerHeight);
                            d = e.getXdRelation || p.getXdRelation;
                            c = d(g.params);
                            !(g.id in p._defaultCb) && !("next" in g.params) && !("redirect_uri" in g.params) && (g.params.next = p._xdResult(g.cb, g.id, c, !0));
                            (c === "parent" || c === "opener") && ES("Object", "assign", !1, g.params, {
                                channel_url: p._xdChannelHandler(f, c === "parent" ? "parent.parent" : "opener")
                            }, !0);
                            g = p.prepareParams(g);
                            return g
                        },
                        prepareParams: function(a) {
                            ...
                            !b("sdk.UA").nativeApp() && p.urlTooLongForIE(a.url + "?" + c) ? a.post = !0 : c && (a.url += "?" + c);
                            return a
                        },
                        ...
                        getDisplayMode: function(a, c) {
                            ...
                            if ((c.display == "iframe" || c.display == "dialog") && !p.canIframe(c)) {
                                b("Log").error('"dialog" mode can only be used when the user is connected.');
                                return "popup"
                            }
                            return a.connectDisplay && !d ? a.connectDisplay : c.display || (p.canIframe(c) ? "dialog" : "popup")
                        },
                        ...
                        popup: function(a) {
                            var c = b("sdk.Popup").popup(a, p.isOAuth({
                                method: a.name
                            }));
                            c && (p.setLoadedNode(a, c, "popup"), a.id in p._defaultCb && p._popupMonitor())
                        },
                        ...
                        hidden: function(a) {
                            a.className = "FB_UI_Hidden", a.root = b("sdk.Content").appendHidden(document.createElement("div")), p._insertIframe(a)
                        },
                        iframe: function(a) {
                            ...
                            var c = function() {
                                    var c = ES("JSON", "stringify", !1, {
                                        error_code: 4201,
                                        error_message: b("sdk.fbt")._( /*FBT_CALL*/ "User canceled the Dialog flow" /*FBT_CALL*/ )
                                    });
                                    p._triggerDefault(a.id, c)
                                },
                                d = {
                                    onClose: c,
                        ...
                        touch: function(a) {
                            ...
                            }, 0) : p.iframe(a) : b("sdk.UA").nativeApp() && !a.ui_created ? (a.frame = a.id, b("sdk.Native").onready(function() {
                                p.setLoadedNode(a, b("sdk.Native").open(a.url + "#cb=" + a.frameName), "native")
                        ...
                        _popupMonitor: function() {
                            var a;
                            for (var c in p._loadedNodes)
                                if (Object.prototype.hasOwnProperty.call(p._loadedNodes, c) && c in p._defaultCb) {
                                    var d = function() {
                                        var d = p._loadedNodes[c];
                                        if (d.type != "popup" && d.type != "native") return "continue";
                                        var e = d.node;
                                        try {
                                            e.closed ? p.isOAuth(d) ? b("sdk.Auth").getLoginStatus(function(a) {
                                                a.status === "connected" && d.params != null && d.params.return_scopes ? b("sdk.api")("/me/permissions", function(b) {
                                                    (!b || b.error) && p._triggerDefault(c, a);
                                                    var d = "";
                                                    for (var e = 0; e < b.data.length; e++) b.data[e].status === "granted" && (d !== "" && (d += ","), d += b.data[e].permission);
                                                    a.authResponse.grantedScopes = d;
                                                    p._triggerDefault(c, a)
                                                }) : (a.status !== "connected" && (a.closeWindow = !0), p._triggerDefault(c, a))
                                            }, !0) : p._triggerDefault(c, null) : a = !0
                                        } catch (a) {}
                                    }();
                        ...
                        _xdChannelHandler: function(a, c) {
                            return b("sdk.XD").handler(function(c) {
                                var d = p.getLoadedNode(a);
                                if (!d) return;
                                if (c.type == "resize") p._handleResizeMessage(a, c);
                        ...
                        _xdRecv: function(a, c) {
                            var d = p.getLoadedNode(a.frame);
                            if (d)
                                if (d.close) try {
                                    d.close(), /iPhone.*Version\/(5|6)/.test(navigator.userAgent) && RegExp.$1 !== "5" && window.focus(), p._popupCount--
                        ...
                        xdHandler: function(a, c, d, e, f, g, h) {
                            return p._xdNextHandler(b("sdk.Auth").xdResponseWrapper(a, e, f, h), c, d, g)
                        },
                ...
                __d("legacy:fb.auth", ["FB", "Log", "sdk.Auth", "sdk.Cookie", "sdk.Event", "sdk.Runtime", "sdk.Scribe", "sdk.SignedRequest", "sdk.ui", "sdk.warnInsecure"], (function(a, b, c, d, e, f) {
                    b("FB").provide("", {
                    ...
                    c.subscribe("init:post", function(a) {
                        a.legacyStatusInit ? b("sdk.Auth").getLoginStatus(function(a) {
                            a != null && a.status === "connected" && b("sdk.Scribe").log("jssdk_error", {
                ...
                __d("sdk.init", ["Log", "ManagedError", "QueryString", "sdk.AppEvents", "sdk.Cookie", "sdk.ErrorHandling", "sdk.Event", "sdk.Frictionless", "sdk.MBasicInitializer", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD"], (function(a, b, c, d, e, f, g) {
                    b("sdk.XD");
                    b("sdk.AppEvents");
                    b("sdk.Frictionless");
                ...
                __d("sdk.Time", ["Log", "sdk.Impressions", "sdk.Runtime", "sdk.feature"], (function(a, b, c, d, e, f, g) {
                    ...
                    if (i) {
                        ...
                        if (e.length > 1)
                            ...
                            f && f instanceof HTMLIFrameElement && (b = f.contentWindow.performance.getEntriesByType("resource").find(function(a) {
                                return ES(a.name, "startsWith", !0, l)
                            }));
                            e = e[0]
                        } else e = null;
                        e && (k.fetchTime = Math.round(e.duration), b && (k.fetchTime += Math.round(b.duration)), "transferSize" in e && (k.transferSize = e.transferSize, b && (k.transferSize += b.transferSize)), d("Log").debug("sdkperf: it took %s ms and %s bytes to load %s", k.fetchTime, k.transferSize, l), j = e.startTime, k.ns = c("sdk.Runtime").getSDKNS(), j && window.setTimeout(function() {
                ...
                __d("sdk.createIframe", ["DOMEventListener", "getBlankIframeSrc", "guid", "isNumberLike"], (function(a, b, c, d, e, f, g) {
                    function a(a) {
                        ...
                        if (j) var m = d("DOMEventListener").add(e, "load", function() {
                            m.remove(), j()
                        });
                        if (k) var n = d("DOMEventListener").add(e, "error", function() {
                            n.remove(), k()
                        });
                        e.src = i;
                        return e
                ...
                __d("IframePlugin", ["Log", "ObservableMixin", "QueryString", "Type", "UrlMap", "guid", "sdk.Auth", "sdk.AuthUtils", "sdk.DOM", "sdk.Event", "sdk.PlatformVersioning", "sdk.PluginUtils", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD", "sdk.createIframe"], (function(a, b, c, d, e, f, g) {
                    var h = c("Type").extend({
                ...
                __d("UserAgent", ["UserAgentData", "VersionRange", "memoizeStringOnly"], (function(a, b, c, d, e, f, g) {
                    ...
                    function h(a, b, d, e) {
                        if (a === d) return !0;
                        if (!ES(d, "startsWith", !0, a)) return !1;
                        d = d.slice(a.length);
                        if (b != null) {
                            d = e ? e(d) : d;
                ...
                __d("LiveChatPluginUtils", ["UserAgent"], (function(a, b, c, d, e, f, g) {
                    var h = 44,
                        i = 36,
                        j = 60,
                        k = 44,
                    ...
                    function a() {
                        return (c("UserAgent").isBrowser("Safari >= 12") || c("UserAgent").isBrowser("Mobile Safari >= 12") || c("UserAgent").isBrowser("Firefox >= 62")) && typeof document.hasStorageAccess === "function"
                    }

                    function b() {
                        return (c("UserAgent").isBrowser("Safari >= 12") || c("UserAgent").isBrowser("Mobile Safari >= 12")) && typeof document.hasStorageAccess === "function"
                    }
                    ...
                    function f(a, b, c, d, e, f, g, h) {
                        return ES("JSON", "stringify", !1, p(a, b, c, d, e, f, g, h))
                    }
                    ...
                    function r(a, b, c, d, e, f) {
                        c = c + (a == "right" ? -2 : 43);
                        var g = b + j - 16;
                        e ? (g = b - 16, d === "none" ? f === "compact" ? g += k : g += j : f === "compact" ? g += i : g += h) : f === "compact" && (g = b + k - 16);
                        e = {
                    ...
                    function t(a, b, c, d, e, f, g) {
                        c = c - l;
                        var m = j;
                        f ? e === "none" ? g === "compact" ? m = k : m = j : g === "compact" ? m = i : m = h : g === "compact" && (m = k);
                        f = m + b;
                        e = " bottom: " + f.toString() + "px;";
                        g = "padding: 0; position: fixed; z-index: 2147483646; border-radius: 16px; top: auto; width: 399px; background: none; minHeight: 300px;" + e;
                        m = g;
                        d ? m += "max-height: calc(100% - " + f.toString() + "px);" : m += "max-height: 0;";
                        switch (a) {
                            case "right":
                    ...
                    function v(a, b, c, d, e, f, g) {
                        c = c - l;
                        var m = j + l;
                        f ? (m = l, e === "none" ? g === "compact" ? m += k : m += j : g === "compact" ? m += i : m += h) : g === "compact" && (m = k + l);
                        f = m + b;
                        e = " bottom: " + f.toString() + "px;";
                        g = "padding: 0; position: fixed; z-index: 2147483646;border-radius: 16px; top: auto; width: 247px; max-height: calc(100% - 80px); background: none;" + e;
                        m = g;
                        switch (a) {
                            case "right":
                                m += "right: 4px; margin-right: " + c + "px;";
                        ...
                        m += Boolean(d) ? "animation: slideInFromBottomDelay 6s ease-out;" : "animation: slideInFromBottomDelay 3s ease-out;";
                        return m
                    }

                    function w(a, b, c, d, e, f, g) {
                        var l = g === "compact" ? k : j,
                            m = "position: fixed; z-index: 2147483646; box-shadow: none; border-radius: 18px 0px 18px 18px; bottom: 0px; right: 0px; width: calc(80% - 40px); bottom: 24px;";
                        ...
                        m += Boolean(c) ? "animation: slideInFromBottomDelay 6s ease-in;" : "animation: slideInFromBottomDelay 3s ease-in;";
                    ...
                    function x(a) {
                        if (a == null || a === "") return null;
                        else if (ES("Array", "from", !1, a).length > 80 || typeof a !== "string") return null;
                        else return a
                    }
                    g.LABELED_ENTRY_POINT_STANDARD_HEIGHT = h;
                    g.LABELED_ENTRY_POINT_COMPACT_HEIGHT = i;
                    g.ICON_ENTRY_POINT_STANDARD_HEIGHT = j;
                    g.ICON_ENTRY_POINT_COMPACT_HEIGHT = k;
                    g.getIsITPUserAgent = a;
                    g.getIsSafari12OrAbove = b;
                    g.getMobileStyleText = d;
                    g.positionElementAtWindowFooter = e;
                    g.getEntryPointStyle = p;
                    g.getIconStyleText = f;
                    g.getUnreadCountStyleText = r;
                    g.getMobileLandingStyleText = s;
                    g.getDesktopStyleText = t;
                    g.getMobileFullScreenStyleText = u;
                    g.getDesktopWelcomeMessageStyleText = v;
                    g.getMobileWelcomeMessageStyleText = w;
                    g.getSanitizedGreetingText = x
                }), 98);
                ...
                __d("sdk.XFBML.ChatDOM", ["$InternalEnum", "CORSRequest", "ChatPluginEntryPointSizeEnum", "ChatPluginSDKPreLoggingUtils", "DOMPlugin", "LiveChatPluginUtils", "Log", "UrlMap", "getJSEnumSafe", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.IdleCallback", "sdk.XFBML.CustomerChatNew", "sdk.feature", "uuid"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    ...
                    a = function(a) {
                        ...
                        e.render = function(a) {
                            ...
                            c("CORSRequest").execute(a, "get", this.params, function(a) {
                                ...
                                d("Log").info("facadeperf: CORS request completed in %sms.", e - b.$ChatDOMFacade4);
                                ...
                                b.$ChatDOMFacade8 = (a = c("getJSEnumSafe")(c("ChatPluginEntryPointSizeEnum"), a)) != null ? a : "standard";
                                a = d("LiveChatPluginUtils").getEntryPointStyle(e, f, g, !1, !0, void 0, !1, b.$ChatDOMFacade8);
                        ...
                        e.$ChatDOMFacade11 = function() {
                            ...
                            var a = this.$ChatDOMFacade8 === "compact" ? d("LiveChatPluginUtils").ICON_ENTRY_POINT_COMPACT_HEIGHT : d("LiveChatPluginUtils").ICON_ENTRY_POINT_STANDARD_HEIGHT;
                ...
                __d("MPNLocalState", [], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    a = {
                        LANDING_BANNER: 1,
                        WELCOME_PAGE: 2,
                ...
                __d("sdk.XFBML.CustomerChat", ["ChatPluginSDKPreLoggingUtils", "DOMEventListener", "IframePlugin", "Log", "MPNLocalState", "QueryString", "UrlMap", "getFacebookOriginForTarget", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.DocumentTitle", "sdk.Event", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.WebStorage", "sdk.XD", "sdk.XFBML.CustomerChatWrapper", "sdk.createIframe", "uuid"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    var h = ["animationend", "mozAnimationEnd", "MSAnimationEnd", "oAnimationEnd", "webkitAnimationEnd"],
                        ...
                        B = c("IframePlugin").extend({
                            ...
                            _updateDialogIframeOptions: function() {
                                ...
                                b != null && ES("Object", "assign", !1, this._params, {
                                    local_state: b
                                });
                                a = c("performanceAbsoluteNow")();
                                b = c("uuid")();
                            ...
                            _handleSetupIconIframe: function(a) {
                                ...
                                o = c("sdk.createIframe")({
                                    ...
                                    onload: function() {
                                        d("ChatPluginSDKPreLoggingUtils").preLogging("chat_plugin_sdk_icon_iframe_load", b._params), k = l, b._notifyDialogIFrame(), window.setTimeout(function() {
                                            d("sdk.DOM").remove(i)
                                        }, 100)
                                    }
                                });
                            ...
                            _handleUpdateDialogAppearance: function(a) {
                                ...
                                a != null && d("sdk.DOM").setStyle(this._iframe, "margin", a);
                            ...
                            _handleReload: function(a) {
                                var b, e = new(c("sdk.URI"))(this._iframe.src),
                                    f = e.getQueryData();
                                ...
                                a.hasExplicitInteraction && (f.has_explicit_interaction = "1");
                                e.setQueryData(f);
                            ...
                            _handleUpdatePageTitle: function(a) {
                                var b = this;
                                !i && a.titleText ? (i = d("sdk.DocumentTitle").blink(a.titleText), d("DOMEventListener").add(window, "focus", function(a) {
                                    b._stopBlinking()
                    ...
                    function C(a, b) {
                        ...
                        n === null ? c("getFacebookOriginForTarget")(function(a) {
                            n = a, d(n)
                        }, window.frames[a]) : d(n)
                    }
                    ...
                    function I(a) {
                        ...
                        if (t === null || t === !0) {
                            ...
                            h.forEach(function(b) {
                                var c = function(b) {
                                    p && (d("sdk.DOM").setStyle(a, "maxHeight", "0"), d("sdk.DOM").setStyle(a, "minHeight", "0"), h.forEach(function(b) {
                ...
                __d("IframePluginClass", ["Log", "QueryString", "UrlMap", "guid", "sdk.Auth", "sdk.AuthUtils", "sdk.DOM", "sdk.Event", "sdk.Observable", "sdk.PlatformVersioning", "sdk.PluginUtils", "sdk.Runtime", "sdk.UA", "sdk.URI", "sdk.XD", "sdk.createIframe"], (function(a, b, c, d, e, f, g) {
                    a = function(a) {
                        babelHelpers.inheritsLoose(b, a);
                ...
                __d("sdk.cp.Actions", ["DOMEventListener", "MPNSingletonProvider", "sdk.DOM", "sdk.DocumentTitle", "sdk.URI", "sdk.WebStorage", "sdk.cp.Constants"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    var h = function() {
                        function a() {}
                        var b = a.prototype;
                        b.reloadIframe = function(a, b) {
                            ...
                            b === "true" && (g.has_explicit_interaction = "1");
                            f.setQueryData(g);
                            a.src = f.valueOf()
                        };
                        b.setDialogAppearance = function(a, b) {
                            ...
                            b != null && d("sdk.DOM").setStyle(a, "margin", b);
                ...
                __d("sdk.XFBML.CustomerChatNew", ["ChatPluginSDKPreLoggingUtils", "DOMEventListener", "IframePluginClass", "Log", "MPNLocalState", "QueryString", "UrlMap", "getFacebookOriginForTarget", "performanceAbsoluteNow", "sdk.Content", "sdk.DOM", "sdk.DialogUtils", "sdk.Event", "sdk.UA", "sdk.WebStorage", "sdk.XD", "sdk.XFBML.CustomerChatWrapper", "sdk.cp.Actions", "sdk.cp.Animation", "sdk.cp.Constants", "sdk.cp.Storage", "sdk.createIframe"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    a = function(a) {
                        babelHelpers.inheritsLoose(b, a);
                        ...
                        e.$CustomerChat12 = function() {
                            ...
                            b = d("UrlMap").resolve("www") + "/plugins/" + this.tag + ".php?";
                            this.iframeOptions.url = b + c("QueryString").encode(this.params);
                        ...
                        e.$CustomerChat16 = function(a) {
                            ...
                            this.$CustomerChat3 = c("sdk.createIframe")({
                                ...
                                "data-testid": "bubble_iframe",
                                onload: function() {
                                    d("ChatPluginSDKPreLoggingUtils").preLogging("chat_plugin_sdk_icon_iframe_load", b.params), b.$CustomerChat2 = j, b.$CustomerChat19(), b.$CustomerChat20(), window.setTimeout(function() {
                                        d("sdk.DOM").remove(i)
                                    }, 100)
                                }
                            });
                        ...
                        e.$CustomerChat24 = function(a, b) {
                            ...
                            this.$CustomerChat9 === null ? c("getFacebookOriginForTarget")(function(a) {
                                d.$CustomerChat9 = a, f(d.$CustomerChat9)
                            }, e) : f(this.$CustomerChat9)
                        };
                        ...
                        e.$CustomerChat22 = function(a) {
                            ...
                            if (!this.$CustomerChat10) {
                                ...
                                c("sdk.cp.Constants").animationEvents.forEach(function(e) {
                                    var f = function(e) {
                                        b.$CustomerChat10 && (d("sdk.DOM").setStyle(a, "maxHeight", "0"), d("sdk.DOM").setStyle(a, "minHeight", "0"), c("sdk.cp.Constants").animationEvents.forEach(function(b) {
                ...
                __d("sdk.XFBML.CustomerChatWrapper", ["$InternalEnum", "CORSRequest", "UrlMap", "sdk.Observable", "sdk.XFBML.ChatDOM", "sdk.XFBML.CustomerChat"], (function(a, b, c, d, e, f, g) {
                    a = b("$InternalEnum")({
                        SHOW: "SHOW",
                        HIDE: "HIDE",
                ...
                __d("sdk.XFBML.LoginButton", ["IframePlugin", "Log", "guid", "safeEval", "sdk.Auth", "sdk.Dialog", "sdk.ErrorHandling", "sdk.Impressions", "sdk.PluginUtils", "sdk.Runtime", "sdk.Scribe", "sdk.UIServer", "sdk.XD", "sdk.feature", "sdk.getContextType", "sdk.ui"], (function(a, b, c, d, e, f, g) {
                    var h = c("sdk.feature")("https_only_learn_more", "");
                ...
                __d("legacy:fb.xfbml.plugins", ["IframePlugin", "PluginConfig", "PluginTags", "XFBML", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.CustomerChatWrapper", "sdk.XFBML.LWIAdsCreation", "sdk.XFBML.LWIAdsInsights", "sdk.XFBML.LoginButton", "sdk.XFBML.Quote", "sdk.XFBML.Save", "sdk.XFBML.ShareButton", "sdk.XFBML.Video", "sdk.feature"], (function(a, b, c, d, e, f) {
                    var g = {
                            ...
                            customerchat: b("sdk.XFBML.CustomerChatWrapper").CustomerChatWrapperPlugin,
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1004658278","namespace":"FB","message":"' + e.message + '"}}');

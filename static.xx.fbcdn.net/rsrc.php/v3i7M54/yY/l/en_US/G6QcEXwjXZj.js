if (self.CavalryLogger) {
    CavalryLogger.start_js(["p0usZjQ"]);
}
...
__d("QPLCore", ["QPLEvent", "QPLTimestamp", "QPLUtils", "QuickPerformanceLoggerTypes"], (function(a, b, c, d, e, f, g) {
    "use strict";
    ...
    a = function() {
        ...
        b.markerStart = function(a, b, c, e) {
            ...
            this.getMarker(a, b) && (this.$7.warn("Duplicate QPL event: " + d("QPLEvent").getMarkerId(a) + " & instanceKey: " + b), f && (this.$7.warn("Cancelling duplicate QPL markerId: " + d("QPLEvent").getMarkerId(a) + " & instanceKey: " + b), this.markerEnd(a, 4, b, c)));
            f = this.$10(a, j);
            j = f[0];
            var k = f[1];
            f = f[2];
...
__d("QuickPerformanceLogger", ["Arbiter", "Bootloader", "Env", "FBLogger", "PerfFalcoEvent", "PerfXSharedFields", "Promise", "QPLCore", "QPLEvent", "Run", "USID", "WebStorage", "cr:1367102", "cr:1984081", "gkx", "performanceAbsoluteNow", "performanceNavigationStart", "performanceNow"], (function(a, b, c, d, e, f) {
    "use strict";
    var g, h, i, j;
    ...
    var p = (h || (h = b("performanceAbsoluteNow")))();
    ...
    c = function(a) {
        ...
        d.$QuickPerformanceLogger1 = function() {
            ...
            if (c.length > 0) {
                ...
                e = j.setItemGuarded(e, r, JSON.stringify(d));
                e && (c.forEach(function(b) {
                    var c = b[0],
                        d = b[1];
                    b = b[2];
                    c = l(c, b.sampleRate, b.samplingMethod);
                    a.markerEnd(c, 96, d)
            ...
            this.activeMarkers.forEach(function(b, f) {
                b.forEach(function(b, g) {
                    if (!e || b.cancelOnUnload === !0) {
                        b = l(f, b.sampleRate, b.samplingMethod);
                        c.markerEnd(b, a, g, d)
                    }
                })
            })
    ...
    function e(a, b, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
        ...
        this.action(a, function(a) {
            ...
            a = {
                ...
                display: "popup",
                logger_id: m,
                force_confirmation: p,
                messenger_page_id: q,
                reset_messenger_state: r
            };
            c("Arbiter").subscribe("Connect.Unsafe.loginComplete", function() {
                new(c("PluginLoginButtonEventsTypedLogger"))().setEvent("login_complete").setAppID(b).setLoggerID(m).setIsLegacy(n).setLayout(o).logVital(), d("PlatformOAuthDialogLoginFunnelLogger").log("client_login_end", null, m, !1)
            });
            c("UnverifiedXD").send({
                type: "login_button_dialog_open",
                params: JSON.stringify(a)
            });
            new(c("PluginLoginButtonEventsTypedLogger"))().setEvent("click").setAppID(b).setLoggerID(m).setIsLegacy(n).setLayout(o).logVital();
            d("PlatformOAuthDialogLoginFunnelLogger").log("client_login_start", null, m, !1)
        })
    }

    function f(a, b, e, f, g, k, l, m, n, o, p, q, r, s, t, u) {
        f = function(a, b) {
            if (o) {
                a = d("PlatformWidgetEndpoint").plugins("login_button");
                d("PluginReturn").reload(a + (b.crossFrame ? "" : "?ret=perms"))
        ...
        var v = {
            ...
            logger_id: p,
            version: g,
            force_confirmation: s,
            messenger_page_id: t,
            reset_messenger_state: u
        };
        ...
        c("Arbiter").subscribe("Connect.Unsafe.loginComplete", function(a, e) {
            h[e.frame_name] != null && typeof h[e.frame_name].close === "function" && (h[e.frame_name].close(), delete h[e.frame_name]), e.status === "connected" ? j = null : c("UnverifiedXD").send({
                type: "login_button_prepare_call",
                params: JSON.stringify(v)
            }), new(c("PluginLoginButtonEventsTypedLogger"))().setEvent("login_complete").setAppID(b).setLoggerID(p).setIsLegacy(q).setLayout(r).logVital(), d("PlatformOAuthDialogLoginFunnelLogger").log("client_login_end", null, p, !1)
        });
        this.action(a, function(a) {
            new(c("DOMEvent"))(a).kill();
            if (j == null) c("UnverifiedXD").send({
                ...
                new(c("PluginLoginButtonEventsTypedLogger"))().setEvent("click").setAppID(b).setLoggerID(p).setIsLegacy(q).setLayout(r).logVital();
                d("PlatformOAuthDialogLoginFunnelLogger").log("client_login_start", null, p, !1)
            }
        })
    }
